...
describe("exportMapChartConfig", () => {
  ...
  it("accepts ParsedSave directly", () => {
    const parsed = {
      ...
      overlordSubjects: {},
      countryNames: {}, countryStats: {}, locationRgos: {}, countryProduction: {}, goodsRankings: {}, wars: [], pastWars: [], warReparations: [], annulledTreaties: [], royalMarriages: [], activeCBs: [], trade: { producedGoods: {}, marketNames: {}, marketOwners: {}, markets: [] },
    };
