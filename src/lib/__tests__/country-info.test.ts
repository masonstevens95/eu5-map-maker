...
describe("buildCountryInfo", () => {
  it("builds info from parsed save", () => {
    const parsed = {
      ...
      countryStats: {}, locationRgos: {}, countryProduction: {}, goodsRankings: {}, goodAvgPrices: {}, wars: [], pastWars: [], warReparations: [], annulledTreaties: [], royalMarriages: [], activeCBs: [], trade: { producedGoods: {}, marketNames: {}, marketOwners: {}, markets: [] },
    };
