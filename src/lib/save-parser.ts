...
export const parseMeltedSave = (text: string): ParsedSave => {
  ...
  return { countryLocations, tagToPlayers, countryColors, overlordSubjects, countryNames: {}, countryStats: {}, wars: [], trade: { producedGoods: {}, marketNames: {}, marketOwners: {}, markets: [] } };
};
